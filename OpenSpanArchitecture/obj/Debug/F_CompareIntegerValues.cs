...
[OpenSpan.Design.ComponentIdentityAttribute("Automator-8D2B5115AF9DD91")]
[System.ComponentModel.ToolboxItemAttribute(false)]
public sealed class F_CompareIntegerValues : OpenSpan.Automation.Automator
{
	
	[OpenSpan.Design.ComponentIdentityAttribute("Automator-8D2B5115AF9DD91\\EntryPoint-8D2B511657614C7")]
	public OpenSpan.Automation.EntryPoint entryPoint1;
	
	[OpenSpan.Design.ComponentIdentityAttribute("Automator-8D2B5115AF9DD91\\HiddenTypeProxy-8D2B51166DB3E73")]
	public OpenSpan.Automation.HiddenTypeProxy hiddenTypeProxy1;
	
	[OpenSpan.Design.ComponentIdentityAttribute("Automator-8D2B5115AF9DD91\\HiddenTypeProxy-8D2B51177D9C2E8")]
	public OpenSpan.Automation.HiddenTypeProxy hiddenTypeProxy2;
	
	[OpenSpan.Design.ComponentIdentityAttribute("Automator-8D2B5115AF9DD91\\BooleanExpression-8D2B511C0020A7A")]
	public OpenSpan.Script.Expression.BooleanExpression booleanExpression;
	
	private OpenSpan.Automation.ConnectableMethod connectableMethod1;
	
	private OpenSpan.Automation.ExitPoint exitPoint1;
	
	public F_CompareIntegerValues()
	{
		System.ComponentModel.ComponentResourceManager _resources_ = new System.ComponentModel.ComponentResourceManager(typeof(F_CompareIntegerValues));
		...
		// 
		this.Id = new OpenSpan.Design.ComponentIdentity("Automator-8D2B5115AF9DD91");
		// 
		// Set component Ids
		// 
		this.SetId(this.entryPoint1, new OpenSpan.Design.ComponentIdentity("EntryPoint-8D2B511657614C7"));
		this.SetId(this.hiddenTypeProxy1, new OpenSpan.Design.ComponentIdentity("HiddenTypeProxy-8D2B51166DB3E73"));
		this.SetId(this.hiddenTypeProxy2, new OpenSpan.Design.ComponentIdentity("HiddenTypeProxy-8D2B51177D9C2E8"));
		this.SetId(this.booleanExpression, new OpenSpan.Design.ComponentIdentity("BooleanExpression-8D2B511C0020A7A"));
		this.SetId(this.connectableMethod1, new OpenSpan.Design.ComponentIdentity("ConnectableMethod-8D2B511C009F9EE"));
		this.SetId(this.exitPoint1, new OpenSpan.Design.ComponentIdentity("ExitPoint-8D2B511D478E834"));
		// 
		// F_CompareIntegerValues
		// 
		ComponentInfo.CodeDomData = _resources_.GetString("_F_CompareIntegerValues_1_");
		this.DocumentScale = 0.9900374F;
		dynamicmethodinfo1.BlockTypeName = "OpenSpan.Automation.Design.ConnectionBlocks.EntryPointExecuteBlock";
		dynamicmethodinfo1.Source = "";
		dynamicmethodinfo1.Visibility = OpenSpan.TypeManagement.MemberVisibilityLevel.DefaultOn;
		dynamicmethodinfo1.CodeDomData = _resources_.GetString("_F_CompareIntegerValues_2_");
		...
		this.Name = "F_CompareIntegerValues";
		...
		dynamicpropertyinfo1.CodeDomData = _resources_.GetString("_F_CompareIntegerValues_3_");
		...
		dynamicpropertyinfo2.CodeDomData = _resources_.GetString("_F_CompareIntegerValues_3_");
		...
		dynamicpropertyinfo3.CodeDomData = _resources_.GetString("_F_CompareIntegerValues_4_");
		...
		dynamicpropertyinfo4.CodeDomData = _resources_.GetString("_F_CompareIntegerValues_5_");
		...
		dynamicpropertyinfo5.CodeDomData = _resources_.GetString("_F_CompareIntegerValues_6_");
		...
		this.entryPoint1.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("Automator-8D2B5115AF9DD91\\EntryPoint-8D2B511657614C7");
		...
		dynamicmethodinfo2.CodeDomData = _resources_.GetString("_F_CompareIntegerValues_7_");
		...
		dynamicpropertyinfo6.CodeDomData = _resources_.GetString("_F_CompareIntegerValues_8_");
		...
		this.connectableMethod1.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("Automator-8D2B5115AF9DD91\\BooleanExpression-8D2B511C0020A7A");
		...
		dynamicpropertyinfo7.CodeDomData = _resources_.GetString("_F_CompareIntegerValues_9_");
		...
		this.exitPoint1.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("Automator-8D2B5115AF9DD91\\EntryPoint-8D2B511657614C7");
		// 
		// Initialize CodeDom data
		// 
		this.CodeDomData = _resources_.GetString("_F_CompareIntegerValues_10_");
		// 
		// Add components
		// 
	...
	internal OpenSpan.Automation.EntryPoint Create_entryPoint1(out System.Collections.Generic.ICollection<System.ComponentModel.IComponent> components)
	{
		...
		this.SetId(entryPoint1, new OpenSpan.Design.ComponentIdentity("EntryPoint-8D2B511657614C7"));
		...
		// Set designComp Ids
		// 
		this.SetId(hiddenTypeProxy1, new OpenSpan.Design.ComponentIdentity("HiddenTypeProxy-8D2B51166DB3E73"));
		this.SetId(hiddenTypeProxy2, new OpenSpan.Design.ComponentIdentity("HiddenTypeProxy-8D2B51177D9C2E8"));
		// 
		// Add components
		// 
	...
	internal OpenSpan.Script.Expression.BooleanExpression Create_booleanExpression(out System.Collections.Generic.ICollection<System.ComponentModel.IComponent> components)
	{
		...
		this.SetId(booleanExpression, new OpenSpan.Design.ComponentIdentity("BooleanExpression-8D2B511C0020A7A"));
		this.SetScope(booleanExpression, OpenSpan.Design.ConnectableScope.Local);
		OpenSpan.DynamicMembers.DynamicMethodInfo dynamicmethodinfo1 = new OpenSpan.DynamicMembers.DynamicMethodInfo();
		dynamicmethodinfo1.Source = "";
		dynamicmethodinfo1.Visibility = OpenSpan.TypeManagement.MemberVisibilityLevel.DefaultOn;
		dynamicmethodinfo1.CodeDomData = _resources_.GetString("_F_CompareIntegerValues_7_");
	...
	internal OpenSpan.Automation.ConnectableMethod Create_connectableMethod1(out System.Collections.Generic.ICollection<System.ComponentModel.IComponent> components)
	{
		...
		this.SetId(connectableMethod1, new OpenSpan.Design.ComponentIdentity("ConnectableMethod-8D2B511C009F9EE"));
		...
		dynamicpropertyinfo1.CodeDomData = _resources_.GetString("_F_CompareIntegerValues_8_");
		...
		connectableMethod1.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("Automator-8D2B5115AF9DD91\\BooleanExpression-8D2B511C0020A7A");
		OpenSpan.Automation.MemberPrototype memberprototype1 = new OpenSpan.Automation.MemberPrototype();
		memberprototype1.DefaultValue = null;
		memberprototype1.MemberName = "Evaluate";
		memberprototype1.MemberType = System.Reflection.MemberTypes.Method;
	...
	internal OpenSpan.Automation.ExitPoint Create_exitPoint1(out System.Collections.Generic.ICollection<System.ComponentModel.IComponent> components)
	{
		...
		this.SetId(exitPoint1, new OpenSpan.Design.ComponentIdentity("ExitPoint-8D2B511D478E834"));
		...
		dynamicpropertyinfo1.ValidateConnectionCallback = null;
		dynamicpropertyinfo1.Visibility = OpenSpan.TypeManagement.MemberVisibilityLevel.DefaultOn;
		dynamicpropertyinfo1.CodeDomData = _resources_.GetString("_F_CompareIntegerValues_9_");
		...
		dynamicpropertyinfo3.ValidateConnectionCallback = null;
		dynamicpropertyinfo3.Visibility = OpenSpan.TypeManagement.MemberVisibilityLevel.AlwaysHidden;
		dynamicpropertyinfo3.CodeDomData = _resources_.GetString("_F_CompareIntegerValues_3_");
		...
		dynamicpropertyinfo4.ValidateConnectionCallback = null;
		dynamicpropertyinfo4.Visibility = OpenSpan.TypeManagement.MemberVisibilityLevel.AlwaysHidden;
		dynamicpropertyinfo4.CodeDomData = _resources_.GetString("_F_CompareIntegerValues_4_");
		OpenSpan.DynamicMembers.DynamicPropertyInfo dynamicpropertyinfo5 = new OpenSpan.DynamicMembers.DynamicPropertyInfo();
		dynamicpropertyinfo5.IsSerializable = true;
		dynamicpropertyinfo5.NoInputConvesion = false;
		dynamicpropertyinfo5.Source = "";
		dynamicpropertyinfo5.ValidateConnectionCallback = null;
		dynamicpropertyinfo5.Visibility = OpenSpan.TypeManagement.MemberVisibilityLevel.AlwaysHidden;
		dynamicpropertyinfo5.CodeDomData = _resources_.GetString("_F_CompareIntegerValues_5_");
		OpenSpan.DynamicMembers.DynamicPropertyInfo dynamicpropertyinfo6 = new OpenSpan.DynamicMembers.DynamicPropertyInfo();
		dynamicpropertyinfo6.IsSerializable = true;
		dynamicpropertyinfo6.NoInputConvesion = false;
		dynamicpropertyinfo6.Source = "";
		...
		dynamicpropertyinfo6.CodeDomData = _resources_.GetString("_F_CompareIntegerValues_6_");
		entryPoint1.DynamicMembers.Add(dynamicpropertyinfo4);
		entryPoint1.DynamicMembers.Add(dynamicpropertyinfo5);
		...
		exitPoint1.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("Automator-8D2B5115AF9DD91\\EntryPoint-8D2B511657614C7");
		// 
		// Set designComp Ids
		// 
		this.SetId(entryPoint1, new OpenSpan.Design.ComponentIdentity("EntryPoint-8D2B511657614C7"));
