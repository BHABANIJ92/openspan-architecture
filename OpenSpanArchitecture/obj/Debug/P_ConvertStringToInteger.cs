...
public sealed class P_ConvertStringToInteger : OpenSpan.Automation.Automator
{
	...
	public P_ConvertStringToInteger()
	{
		...
		this.SetId(this.exitPoint1, new OpenSpan.Design.ComponentIdentity("ExitPoint-8D2B84351A03772"));
		...
		// 
		this.CodeDomData = _resources_.GetString("_P_ConvertStringToInteger_8_");
		// 
		// Add components
		// 
	...
	internal OpenSpan.Automation.ExitPoint Create_exitPoint1(out System.Collections.Generic.ICollection<System.ComponentModel.IComponent> components)
	{
		...
		this.SetId(exitPoint1, new OpenSpan.Design.ComponentIdentity("ExitPoint-8D2B84351A03772"));
		...
		dynamicpropertyinfo1.CodeDomData = _resources_.GetString("_P_ConvertStringToInteger_6_");
		...
		dynamicpropertyinfo2.ValidateConnectionCallback = null;
		dynamicpropertyinfo2.Visibility = OpenSpan.TypeManagement.MemberVisibilityLevel.AlwaysHidden;
		dynamicpropertyinfo2.CodeDomData = _resources_.GetString("_P_ConvertStringToInteger_3_");
		...
		dynamicpropertyinfo3.ValidateConnectionCallback = null;
		dynamicpropertyinfo3.Visibility = OpenSpan.TypeManagement.MemberVisibilityLevel.AlwaysHidden;
		dynamicpropertyinfo3.CodeDomData = _resources_.GetString("_P_ConvertStringToInteger_4_");
		OpenSpan.DynamicMembers.DynamicPropertyInfo dynamicpropertyinfo4 = new OpenSpan.DynamicMembers.DynamicPropertyInfo();
		dynamicpropertyinfo4.IsSerializable = true;
		dynamicpropertyinfo4.NoInputConvesion = false;
		dynamicpropertyinfo4.Source = "";
		...
		dynamicpropertyinfo4.CodeDomData = _resources_.GetString("_P_ConvertStringToInteger_5_");
		entryPoint1.DynamicMembers.Add(dynamicpropertyinfo3);
