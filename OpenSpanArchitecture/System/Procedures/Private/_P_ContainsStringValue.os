<OpenSpanDesignDocument Version="6.2" Serializer="2.0" Culture="pt-BR">
  ...
  <Component Version="1.0">
      ...
      <AutomationDocument>
        ...
        <Links>
          ...
          <Link PartID="51" Sensitive="False" Asynchronous="False" LogBeforeExecution="" LogAfterExecution="">
            ...
            <To PartID="50" PortName="DoWork" PortType="Method" ConnectableId="Automator-8D2B4856CF7E38D\JumpHost-8D2B9074715DE25" MemberComponentId="Automator-8D2B4856CF7E38D\JumpHost-8D2B9074715DE25" />
            <LinkPoints>
              <Point value="979, 260" />
              <Point value="989, 260" />
              <Point value="995, 260" />
              <Point value="995, 236" />
              <Point value="1013, 236" />
              <Point value="1023, 236" />
            </LinkPoints>
          </Link>
        </Links>
        <Comments>
    ...
    <OpenSpan.Automation.JumpHost Name="jumpHost2" Id="JumpHost-8D2B9074715DE25">
      <ComponentName Value="labelHost1" />
      <DisplayName Value="GoToLabel" />
      <ExceptionsHandled Value="False" />
      <InstanceTypeName Value="OpenSpan.Automation.LabelHost" />
