<OpenSpanDesignDocument Version="6.2" Serializer="2.0" Culture="pt-BR">
  ...
  <Component Version="1.0">
    <OpenSpan.Automation.Automator Name="_P_CompareDoubleValues" Id="Automator-8D2B83C192DB5CE">
      <AutomationDocument>
        ...
        <Objects>
          ...
          <ConnectionBlock>
            <DisplayName Value="CATCH" />
            <ConnectableUniqueId Value="Automator-8D2B83C192DB5CE\CatchHost-8D2B8F7524498B3" />
            <PartID Value="25" />
            <Left Value="600" />
            <Top Value="160" />
            <Collapsed Value="False" />
          ...
          <ConnectionBlock type="OpenSpan.Automation.Design.ConnectionBlocks.EntryPointExecuteBlock">
            <DisplayName Value="Execute" />
            <ConnectableUniqueId Value="Automator-8D2B83C192DB5CE\ConnectableMethod-8D2B8F760A34674" />
            <PartID Value="26" />
            <Left Value="760" />
            <Top Value="200" />
            <Collapsed Value="False" />
          ...
          <ConnectionBlock>
            <DisplayName Value="GoToLabel" />
            <ConnectableUniqueId Value="Automator-8D2B83C192DB5CE\JumpHost-8D2B90720BC3161" />
            <PartID Value="34" />
            <Left Value="1040" />
            <Top Value="199" />
            <Collapsed Value="False" />
        ...
        <Links>
          ...
          <Link PartID="23" Sensitive="False" Asynchronous="False" LogBeforeExecution="" LogAfterExecution="">
            ...
            <LinkPoints>
              ...
              <Point value="872, 345" />
              <Point value="872, 331" />
              <Point value="1033, 331" />
              <Point value="1043, 331" />
            </LinkPoints>
          </Link>
          <Link PartID="24" Sensitive="False" Asynchronous="False" LogBeforeExecution="" LogAfterExecution="">
            ...
            <LinkPoints>
              <Point value="979, 400" />
              <Point value="989, 400" />
              <Point value="1011, 400" />
              <Point value="1011, 331" />
              <Point value="1033, 331" />
              <Point value="1043, 331" />
            </LinkPoints>
          </Link>
          <DecisionEventLink PartID="27" Sensitive="False" Asynchronous="False" LogBeforeExecution="" LogAfterExecution="">
            ...
            <To PartID="25" PortName="DoWork" PortType="Method" ConnectableId="Automator-8D2B83C192DB5CE\CatchHost-8D2B8F7524498B3" MemberComponentId="Automator-8D2B83C192DB5CE\CatchHost-8D2B8F7524498B3" />
            <LinkPoints>
              <Point value="555, 300" />
              <Point value="565, 300" />
              <Point value="565, 300" />
          ...
          <Link PartID="29" Sensitive="False" Asynchronous="False" LogBeforeExecution="" LogAfterExecution="">
            <From PartID="25" PortName="Complete" PortType="Event" ConnectableId="Automator-8D2B83C192DB5CE\CatchHost-8D2B8F7524498B3" MemberComponentId="Automator-8D2B83C192DB5CE\CatchHost-8D2B8F7524498B3" />
          ...
          <Link PartID="30" Sensitive="False" Asynchronous="False" LogBeforeExecution="" LogAfterExecution="">
            <From PartID="25" PortName="_Exception1" PortType="Event" ConnectableId="Automator-8D2B83C192DB5CE\CatchHost-8D2B8F7524498B3" MemberComponentId="Automator-8D2B83C192DB5CE\CatchHost-8D2B8F7524498B3" />
            <To PartID="26" PortName="DoWork" PortType="Method" ConnectableId="Automator-8D2B83C192DB5CE\ConnectableMethod-8D2B8F760A34674" MemberComponentId="Automator-8D2B83C192DB5CE\ConnectableMethod-8D2B8F760A34674" />
            <LinkPoints>
              <Point value="701, 200" />
              <Point value="711, 200" />
              <Point value="715, 200" />
          ...
          <Link PartID="31" Sensitive="False" Asynchronous="False" LogBeforeExecution="" LogAfterExecution="">
            <From PartID="25" PortName="Exception" PortType="Property" ConnectableId="Automator-8D2B83C192DB5CE\CatchHost-8D2B8F7524498B3" MemberComponentId="Automator-8D2B83C192DB5CE\CatchHost-8D2B8F7524498B3" />
            <To PartID="26" PortName="param1" PortType="Property" ConnectableId="Automator-8D2B83C192DB5CE\ConnectableMethod-8D2B8F760A34674" MemberComponentId="Automator-8D2B83C192DB5CE\ConnectableMethod-8D2B8F760A34674" />
            <LinkPoints>
              <Point value="701, 215" />
              <Point value="711, 215" />
              <Point value="715, 215" />
          ...
          <Link PartID="32" Sensitive="False" Asynchronous="False" LogBeforeExecution="" LogAfterExecution="">
            <From PartID="25" PortName="Message" PortType="Property" ConnectableId="Automator-8D2B83C192DB5CE\CatchHost-8D2B8F7524498B3" MemberComponentId="Automator-8D2B83C192DB5CE\CatchHost-8D2B8F7524498B3" />
            <To PartID="26" PortName="_param1" PortType="Property" ConnectableId="Automator-8D2B83C192DB5CE\ConnectableMethod-8D2B8F760A34674" MemberComponentId="Automator-8D2B83C192DB5CE\ConnectableMethod-8D2B8F760A34674" />
            <LinkPoints>
              <Point value="701, 230" />
              <Point value="711, 230" />
              <Point value="715, 230" />
          ...
          <Link PartID="35" Sensitive="False" Asynchronous="False" LogBeforeExecution="" LogAfterExecution="">
            <From PartID="26" PortName="Complete" PortType="Event" ConnectableId="Automator-8D2B83C192DB5CE\ConnectableMethod-8D2B8F760A34674" MemberComponentId="Automator-8D2B4472D6C6FD6\ExitPoint-8D2B4498C5A924F" />
            <To PartID="34" PortName="DoWork" PortType="Method" ConnectableId="Automator-8D2B83C192DB5CE\JumpHost-8D2B90720BC3161" MemberComponentId="Automator-8D2B83C192DB5CE\JumpHost-8D2B90720BC3161" />
            <LinkPoints>
              <Point value="979, 240" />
              <Point value="989, 240" />
              <Point value="995, 240" />
    ...
    <OpenSpan.Automation.CatchHost Name="catchHost2" Id="CatchHost-8D2B8F7524498B3">
      <ComponentName Value="catchHost2" />
      <DisplayName Value="CATCH" />
      <ExceptionsHandled Value="False" />
      <InstanceTypeName Value="OpenSpan.Automation.CatchHost" />
      <InstanceUniqueId Value="Automator-8D2B83C192DB5CE\CatchHost-8D2B8F7524498B3" />
      <MemberDetails Value="" />
      <Content Name="CaughtLinkIDs">
        <Capacity Value="5" />
        <Items>
    ...
    <OpenSpan.Automation.ConnectableMethod Name="connectableMethod3" Id="ConnectableMethod-8D2B8F760A34674">
      <ComponentName Value="F_WriteDiagnosticLogByType" />
      <DisplayName Value="Execute" />
      <ExceptionsHandled Value="False" />
      <InstanceTypeName Value="OpenSpan.Automation.Automator" />
    ...
    <OpenSpan.Automation.JumpHost Name="jumpHost3" Id="JumpHost-8D2B90720BC3161">
      <ComponentName Value="labelHost1" />
      <DisplayName Value="GoToLabel" />
      <ExceptionsHandled Value="False" />
      <InstanceTypeName Value="OpenSpan.Automation.LabelHost" />
